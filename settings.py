...
class Settings:
    def __init__(self, threads, thresh, blur, scale, input_dir, output_dir, processed_dir, watch, output_file_name_prefix, manual_name, manual_metadata, output_format):
